...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "D:\\eclipse workspace\\E-ShopSquare\\src\\main\\webapp\\uploads\\";
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                try {
                    ...
                    int i = DatabaseConnection.insertUpdateFromSqlQuery("insert into tblproduct(active,code,description,image,image_name,name,price,mrp_price,product_category) values('"  + status + "','" + code + "','" + descrip + "','" + imagePath + "','" + imageName + "','" + productName + "','" + productPrice + "','" + mrpPrice + "','" + category + "')");
                    if (i > 0) {
                    	System.out.println("Hello I am if");
        	...
        	System.out.println("Hello I am else");
